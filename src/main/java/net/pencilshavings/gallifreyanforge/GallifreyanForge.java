package net.pencilshavings.gallifreyanforge;
...
@Mod(GallifreyanForge.MOD_ID)
public class GallifreyanForge
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "gallifreyan_forge";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public GallifreyanForge()
    {
